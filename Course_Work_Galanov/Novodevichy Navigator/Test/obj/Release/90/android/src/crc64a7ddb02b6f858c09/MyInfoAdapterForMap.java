...
public class MyInfoAdapterForMap
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Test.MyInfoAdapterForMap, Test", MyInfoAdapterForMap.class, __md_methods);
	}


	public MyInfoAdapterForMap ()
	{
		super ();
		if (getClass () == MyInfoAdapterForMap.class)
			mono.android.TypeManager.Activate ("Test.MyInfoAdapterForMap, Test", "", this, new java.lang.Object[] {  });
	}

	public MyInfoAdapterForMap (android.content.Context p0, java.lang.String p1)
	{
		super ();
		if (getClass () == MyInfoAdapterForMap.class)
			mono.android.TypeManager.Activate ("Test.MyInfoAdapterForMap, Test", "Android.Content.Context, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
