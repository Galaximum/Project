...
public class AdapterForText_MyFilter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Test.AdapterForText+MyFilter, Test", AdapterForText_MyFilter.class, __md_methods);
	}


	public AdapterForText_MyFilter ()
	{
		super ();
		if (getClass () == AdapterForText_MyFilter.class)
			mono.android.TypeManager.Activate ("Test.AdapterForText+MyFilter, Test", "", this, new java.lang.Object[] {  });
	}
